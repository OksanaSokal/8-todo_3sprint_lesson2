...
import {
	...
	removeTodolistAC,
	todolistsReduser
} from './model/todolists-reduser';
import {addTaskAC, changeTaskStatusAC, changeTaskTitleAC, removeTaskAC, tasksReduser} from './model/tasks-reduser';
...
function App() {
	...
	let [todolists, dispatchTodolists] = useReducer(todolistsReduser, [
